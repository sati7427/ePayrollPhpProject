    ...
    function Editbtn(id) {
      ...
      $("#modal-edit").modal("show");
                ...
                <div style="text-align: right;">
                    <button type="button" class="btn btn-sm btn-success" data-toggle="modal" id="test" data-target="#modal-create">
                  Add User
                </button>
            ...
            <?php if(!empty($arr_users)) { ?>
                <?php foreach($arr_users as $user) { ?>
                    <tr>
                        ...
                        <!--<a class="btn btn-sm bg-teal waves-effect" data-toggle="modal" id="test1" data-target="#modal-edit" name="someAction">Edit</a>-->
                        <input type="submit" class="btn btn-sm bg-teal waves-effect"  value="Update" 
                        onClick="Editbtn(<?php echo $user["id"]?>);">
                         <input type="submit" onClick="return confirm('Please confirm deletion');" class="btn btn-sm bg-red waves-effect" name= "delete" value="Delete">
